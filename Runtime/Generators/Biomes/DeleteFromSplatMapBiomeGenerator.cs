...
{
    public class DeleteFromSplatMapBiomeGenerator : BaseBiomeGenerator
    {
        ...
        {
            ComputeShader shader = ComputeShadersContrainer.GetShader("DeleteFromSplatMap");
            int kernel = shader.FindKernel("DeleteFromSplatMap");
